    ...
    <div class="container">
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                <router-link :to="{ name: 'AddNote', params: { id: client.id }} " class="button is-success mb-5">Add note</router-link>
                ...
                >
                    ...
                    <router-link :to="{ name: 'EditNote', params: { id: client.id, note_id: note.id }} " class="button is-success mt-5">Edit note</router-link>
